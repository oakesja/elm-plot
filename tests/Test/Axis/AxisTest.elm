...
axisTranslationTests =
  suite "axisTranslation"
    [ test "for top orient"
        <| assertEqual (transform "translate(0,2)") <| axisTranslation boundingBox Axis.Orient.Top
    , test "for bottom orient"
        <| assertEqual (transform "translate(0,100)") <| axisTranslation boundingBox Axis.Orient.Bottom
    , test "for left orient"
        <| assertEqual (transform "translate(5,0)") <| axisTranslation boundingBox Axis.Orient.Left
    , test "for right orient"
        <| assertEqual (transform "translate(95,0)") <| axisTranslation boundingBox Axis.Orient.Right
    ]
